...
> **Note on llama-stack/ogx:** The llama-stack project is currently being renamed to [ogx](https://github.com/llamastack/llama-stack). While the renaming is in progress, this demo stays with the stable llama-stack version. Once the renaming is complete, this demo will adopt the new naming as well.
